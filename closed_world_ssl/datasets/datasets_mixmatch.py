...
def get_cifar10(args):
    ...
    train_unlabeled_dataset = CIFAR10SSL(args.data_root, train_unlabeled_idxs, train=True, transform=TransformTwice(transform_labeled))
...
def get_cifar100(args):
    ...
    train_unlabeled_dataset = CIFAR100SSL(args.data_root, train_unlabeled_idxs, train=True, transform=TransformTwice(transform_labeled))
...
def get_svhn(args):
    ...
    train_unlabeled_dataset = SVHNSSL(args.data_root, train_unlabeled_idxs, split='train', transform=TransformTwice(transform_labeled))
...
def get_tinyimagenet(args):
    ...
    train_unlabeled_dataset = GenericSSL(os.path.join(args.data_root, 'train'), train_unlabeled_idxs, transform=TransformTwice(transform_labeled))
